...
function Register() {
    ...
    return (
        <div className='h-full py-16 flex items-center justify-center'>
            <form onSubmit={handleRegister} className='lg:w-[500px] p-8 shadow-md shadow-purple-300 rounded-lg border-t border-purple-300'>
                <h1 className='text-center text-4xl font-bold text-slate-700'>Register Now</h1>
                <div className="w-16 h-1 bg-purple-700 mx-auto mb-8 mt-2"></div>
                <div className="mb-6">
                    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your name</label>
                    <input type="text" id="name" name='name' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Your name..." required />
                </div>
                <div className="mb-6">
                ...
                <div className="mb-6">
                    ...
                    <input type="url" id="photo" name='photo' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder='Http...' required />
                </div>
                ...
                <Button type='submit' gradientMonochrome="purple">Login</Button>
                <p className="mt-3">Already have an account? <Link to='/login' className='underline text-purple-500'>Login now</Link></p>

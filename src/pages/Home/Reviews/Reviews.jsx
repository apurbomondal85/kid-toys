            ...
            >
                <SwiperSlide className='shadow-xl'>
                    ...
                    <figure className=" p-8 text-center">
                        ...
                        <blockquote>
                            <p className="text-2xl italic font-medium text-gray-900">"I purchased several educational toys for my kids, and they absolutely love them! The toys are not only entertaining but also promote learning and development. Highly recommended!"</p>
                        </blockquote>
                ...
                <SwiperSlide className='shadow-xl'>
                    ...
                    <figure className=" p-8 text-center">
                        <svg aria-hidden="true" className="w-12 h-12 mx-auto mb-3 text-gray-400" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor" /></svg>
                        <blockquote>
                            <p className="text-2xl italic font-medium text-gray-900">"I'm amazed by the quality and educational value of the toys I bought from this website. My child has shown a great interest in learning while playing with these toys. Thank you!"</p>
                        </blockquote>
                        <figcaption className="flex items-center justify-center mt-6 space-x-3">
                ...
                <SwiperSlide className='shadow-xl'>
                    ...
                    <figure className=" p-8 text-center">
                        <svg aria-hidden="true" className="w-12 h-12 mx-auto mb-3 text-gray-400" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor" /></svg>
                        <blockquote>
                            <p className="text-2xl italic font-medium text-gray-900">"The educational toys I ordered exceeded my expectations. They are well-designed, durable, and have helped my child improve their cognitive and problem-solving skills. I'm very satisfied with my purchase!"</p>
                        </blockquote>
                        <figcaption className="flex items-center justify-center mt-6 space-x-3">
                ...
                <SwiperSlide className='shadow-xl'>
                    ...
                    <figure className=" p-8 text-center">
                        <svg aria-hidden="true" className="w-12 h-12 mx-auto mb-3 text-gray-400" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor" /></svg>
                        <blockquote>
                            <p className="text-2xl italic font-medium text-gray-900">"As an educator, I'm always on the lookout for engaging educational materials. This website offers a fantastic selection of toys that make learning fun and interactive. My students have been thoroughly enjoying them in the classroom!"</p>
                        </blockquote>
                        <figcaption className="flex items-center justify-center mt-6 space-x-3">
